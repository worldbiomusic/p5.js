...
function () {
  ...
  soundfile_createClass(SoundFile, [{
    ...
    /**
     *  p5.SoundFile has three play modes: <code>restart</code>, 
     *  <code>sustain</code> and <code>untilDone</code>. 
     ...
     *    rect(0, height * 2/3, width - 1, height/3 - 1);
     *    textAlign(CENTER, CENTER);
     *    fill(20);
     *    text('restart', width/2, 1 * height/6);
     *    text('sustain', width/2, 3 * height/6);
     *    text('untilDone', width/2, 5 * height/6);
     *  }
     *  function canvasPressed() {
     *    if (mouseY < height/3) {
    ...
    value: function playMode(str) {
      ...
      if (s === 'restart' || s === 'sustain' || s === 'untildone') {
        ...
        throw 'Invalid play mode. Must be either "restart" or "sustain" or "untilDone"';
      }
    }
    /**
